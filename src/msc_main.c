...
static void print_usage(const char* prog) {
    ...
    fprintf(stderr, "\nMultispecies Coalescent Simulation\n");
    fprintf(stderr, "\nOptions:\n");
    fprintf(stderr, "  -v, --verbose    Verbose output\n");
    fprintf(stderr, "  -h, --help       Print this help message\n");
    fprintf(stderr, "\nControl file format:\n");
    fprintf(stderr, "  # Comment lines start with #\n");
    fprintf(stderr, "  species_tree: ((A:1000#0.001,B:1000#0.002):500#0.003,C:1500#0.001)#0.002;\n");
    ...
    fprintf(stderr, "\nNewick format: name:branch_length#theta\n");
